...
--
-- Хост: 127.0.0.1:3307
-- Время создания: Май 18 2019 г., 14:41
...
CREATE TABLE `basket` (
  `id` int(11) NOT NULL,
  `session` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
